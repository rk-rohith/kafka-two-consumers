//package com.kafka.two.consumers.config;
//
...
//
//    @Value(value = "${user.topic.group.id1}")
//    private String userGroupId1;
//
//    @Value(value = "${user.topic.group.id2}")
...
//        props.put(ConsumerConfig.GROUP_ID_CONFIG, userGroupId2);
//        props.put(JsonDeserializer.TRUSTED_PACKAGES, "*");
//        return new DefaultKafkaConsumerFactory<>(props,
